...
/**
 * A serializable {@link Collection}. This means that the implementation of the collection as well as its
 * elements are declared to be {@link java.io.Serializable}.
 *
 * @author Thomas Jensen
 * @param <E> value type
 */
public interface SerializableCollection<E extends Serializable>
